...
public class Texture {
     ...
     */
    public static Image doubleLBP(final Image image, final Size patternSize, final int extrapolationType) {
        /*
         * Verify parameters.
         */
     ...
     *            First LBP float-point value.
     * @return
     *         Value from interval <CODE>[0.0, 1.0]</CODE>.
     */
    public static double hemmingDist(final double lbp1, final double lbp2, final Size patternSize) {
        /*
         * Verify parameters.
         */
