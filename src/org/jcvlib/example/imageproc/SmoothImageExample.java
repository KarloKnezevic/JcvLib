...
public class SmoothImageExample {
    public static void main(String[] args) throws IOException {
        ...
        // Smooth algorithms.
        final Image box = Filters.blur(image, new Size(7, 7), Filters.BLUR_BOX);
        final Image gauss = Filters.blur(image, new Size(11, 11), Filters.BLUR_GAUSSIAN);
        final Image median = Filters.blur(image, new Size(7, 7), Filters.BLUR_MEDIAN);
        final Image kuwahara = Filters.blur(image, new Size(9, 9), Filters.BLUR_KUWAHARA);
