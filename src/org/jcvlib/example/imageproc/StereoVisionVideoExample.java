...
public class StereoVisionVideoExample {
    public static void main(String[] args) throws IOException {
        ...
        WebCamReader webCamLeft = new WebCamReader(0, fps, sizeOfGettingImage);
        webCamLeft.open();
        Window windowLeft = new Window();
        
        WebCamReader webCamRight = new WebCamReader(1, fps, sizeOfGettingImage);
        webCamRight.open();
        Window windowRight = new Window();
        
        Window windowMap = new Window();
