...
public class ThresholdExample {
    public static void main(String[] args) throws IOException {
        ...
        Image imageGray = ColorConvert.fromRGBtoGray(image);
        
        // Apply threshold filter.
        Image imageThreshold = Filters.threshold(imageGray, 127.0, Filters.THRESHOLD_BINARY);
        Image imageAdaptiveT = Filters.adapriveThreshold(imageGray, 7, Filters.ADAPTIVE_GAUSSIAN_INV, 0.0);
