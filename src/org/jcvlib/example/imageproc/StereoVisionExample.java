...
public class StereoVisionExample {
    public static void main(String[] args) throws IOException {
        // Read source image.
        Image left = ImageRW.read("resources" + File.separatorChar + "Aloe-Left.png");
        Image right = ImageRW.read("resources" + File.separatorChar + "Aloe-Right.png");
        
        //        Image grayLeft = ColorConvert.fromRGBtoGray(left.getLayer(0, 3));
        //        Image grayRight = ColorConvert.fromRGBtoGray(right.getLayer(0, 3));
