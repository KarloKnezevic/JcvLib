...
import org.jcvlib.io.VideoFileWriter;
...
public class WriteVideoExample {
    public static void main(String[] args) throws IOException {
        ...
        String filePath = "resources" + File.separatorChar + "Output.mp4";
        
        // Read source image.
        Image image = ImageRW.read("resources" + File.separatorChar + "RGB.png");
        
        VideoFileWriter video = new VideoFileWriter(filePath, image.getSize(), 30, 10, 128);
        video.open();
        
        int diag = Math.min(image.getWidth(), image.getHeight());
        for (int i = 0; i < diag; ++i) {
            // Draw red line.
            image.set8I(i, i, 0, 255);
            image.set8I(i, i, 1, 0);
            image.set8I(i, i, 2, 0);
