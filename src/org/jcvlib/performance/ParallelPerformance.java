...
public class ParallelPerformance {
    ...
    private static double testSingleThreaded(final int width, final int height, final int numOfIterations) {
        // Initialize.
    ...
    private static double testMultiThreaded(final int width, final int height, final int numOfIterations) {
        // Initialize.
        final Image image = new Image(width, height, channels, Image.TYPE_64F, new Color(channels, Color.COLOR_MIN_VALUE));
    ...
    public static void main(String[] args) {
        ...
        final int[] sizes = new int[]{ 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1200, 1500, 2000, 2500, 3000, 3500, 4000, 4500 };
